...
var suggestedButton = Ti.UI.createButton({
	bottom: 0,
	right: 0,
	width: "50%",
	height: 50,
...
var suggested = function(){
	var suggestedFunction = require("suggestedPage");
};

newReleaseButton.addEventListener("click", newRelease);
suggestedButton.addEventListener("click", suggested);

navWindow.add(newReleaseButton, suggestedButton);
navWindow.open();
